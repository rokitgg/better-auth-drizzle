...
import { client, signOut, user } from "@/auth/client";
              ...
              return (
                <div key={sessionItem.id}>
                  <div className="flex items-center gap-2 text-sm  text-black font-medium dark:text-white">
                    {new UAParser(sessionItem.userAgent).getDevice().type ===
                    "mobile" ? (
                      <MobileIcon />
                    ) : (
                      <Laptop size={16} />
                    ...
                    {new UAParser(sessionItem.userAgent).getBrowser().name}
                    <Button
                      variant="destructive"
                      size="sm"
                      className="text-xs ml-1 rounded-full py-0.5 px-3 h-6"
                      onClick={async () => {
